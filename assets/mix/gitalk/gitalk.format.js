...
function() {
    ...
    function(e, t, n) {
        ...
        s = function(e, t, n) {
            ...
            d && (n = t);
            for (c in n)(l = !p && w && void 0 !== w[c]) && u(y, c) || (f = l ? w[c] : n[c], y[c] = d && "function" != typeof w[c] ? n[c] : v && l ? i(f, r) : g && w[c] == f ?
            function(e) {
    ...
    function(e, t, n) {
        ...
        function a(e, t) {
            ...
            r.setUTCFullYear(t),
            r;
            if (n = w.exec(e)) return r = new Date(0),
            o = parseInt(n[1], 10) - 1,
        ...
        function u(e) {
            ...
            if (t = N.exec(e)) return n = parseInt(t[1], 10),
            ...
            e.exports = function(e, n) {
                ...
                function g(e) {
                    ...
                    for (var o = 0; o < e.length; o++) {
                        var a = e[o];
                        if ("function" != typeof a) return u("Invalid argument supplied to oneOfType. Expected an array of check functions, but received " + S(a) + " at index " + o + "."),
                        r
                    }
                    return f(n)
                }
...
*/
    ...
    function(e, t, n) { !
        function() {
            ...
            function i(e) { ! e.__d && (e.__d = !0) && 1 == I.push(e) && (M.debounceRendering || setTimeout)(a)
            }
            function a() {
                var e, t = I;
            ...
            function m() {
                for (var e; e = L.pop();) M.afterMount && M.afterMount(e),
            ...
            function y(e, t, n, r, o) {
                ...
                if (0 !== w) for (var _ = 0; _ < w; _++) {
                    ...
                    c = g(c, s, n, r),
                    c && c !== e && (_ >= v ? e.appendChild(c) : c !== l[_] && (c === l[_ + 1] ? f(l[_]) : e.insertBefore(c, l[_] || null)))
                }
                ...
                if (!e.__x) {
                    ...
                    if (g && (e.props = p, e.state = d, e.context = h, 2 !== t && e.shouldComponentUpdate && !1 === e.shouldComponentUpdate(s, l, f) ? x = !0 : e.componentWillUpdate && e.componentWillUpdate(s, l, f), e.props = s, e.state = l, e.context = f), e.__p = e.__s = e.__c = e.__b = null, e.__d = !1, !x) {
                        ...
                        if ("function" == typeof T) {
                            var A = c(i);
                            a = _,
                            a && a.constructor === T && A.key == a.__k ? C(a, A, 1, f, !1) : (S = a, e._component = a = E(T, A, f), a.__b = a.__b || y, a.__u = e, C(a, A, 0, f, !1), N(a, 1, n, !0)),
                            O = a.base
                        } else u = w,
                        S = _,
                        S && (u = e._component = null),
                        (w || 1 === t) && (u && (u._component = null), O = v(u, i, f, n || !g, w && w.parentNode, !0));
                        if (w && O !== w && a !== _) {
                            var P = w.parentNode;
            ...
            function O(e, t, n, r) {
                ...
                return o && s && (!r || o._component) ? (C(o, l, 3, n, r), e = o.base) : (i && !u && (k(i), e = a = null), o = E(t.nodeName, l, n), e && !o.__b && (o.__b = e, a = null), C(o, l, 1, n, r), e = o.base, a && e !== a && (a._component = null, b(a, !1))),
                e
            }
            function k(e) {
                ...
                e.base = null;
                var n = e._component;
                n ? k(n) : t && (t.__preactattr_ && t.__preactattr_.ref && t.__preactattr_.ref(null), e.__b = t, f(t), x(e), w(t)),
                e.__r && e.__r(null)
            }
            function T(e, t) {
                this.__d = !0,
 ...
 */
            ...
            function() {
                ...
                function y(e, t) {
                    t._state === ne ? x(e, t._result) : t._state === re ? E(e, t._result) : S(t, void 0,
                    function(t) {
                        return w(e, t)
                    },
                    function(t) {
                ...
                function G(e) {
                    ...
                    this._subscribers = [],
                    p !== e && ("function" != typeof e && R(), this instanceof G ? T(this, e) : F())
                }
                function B() {
                    var e = void 0;
                    if (void 0 !== r) e = r;
        ...
        B = function(e) {
            ...
            default)(t)).call(this, e));
                ...
                n.handlePopup = function(e) {
                    ...
                    r = function e(t) { (0, N.hasClassInParent)(t.target, "gt-user", "gt-popup") || (window.document.removeEventListener("click", e), n.setState({
                            isPopupVisible: !1
                        }))
                    };
                    n.setState({
                ...
                n.handleLogin = function() {
                    ...
                    window.localStorage.setItem(R.GT_COMMENT, encodeURIComponent(e)),
            ...
            default)({},
                ...
                default)({},
                    ...
                    e.options),
                    N.axiosJSON.post(n.options.proxy, {
                        code: i,
        ...
        default)(t, [{
                    ...
                    function(e) {
                        ...
                        o.data && (r = r.map(function(t) {
                            if (t.id === e.id) {
                                ...
                                });~r && (t.reactions.totalCount -= 1, t.reactions.nodes.splice(r, 1)),
            ...
            },
            {
                ...
                value: function() {
                    ...
                    l = u.admin,
                    f = r.concat([]);
                    return "last" === a && this.accessToken && f.reverse(),
                    b.
                default.createElement("div", {
            ...
            },
            {
                key: "loginLink",
                get: function() {
                    var e = this.options.client_id,
                    se = this.options.client_secret,
                    t = {
                        client_id: e,
                        client_secret:se,
    ...
    function(e, t, n) {
        ...
        F = function(e) {
            ...
            if (!n._d) {
                ...
                n = n._w || n;
                try {
                    if (n === e) throw E("Promise can't be resolved itself"); (t = P(e)) ? y(function() {
                        var r = {
                            _w: n,
                            _d: !1
                        };
    ...
    function(e, t, n) {
        ...
        Y = function(e, t, n) {
            ...
            t = _(t, !0),
            y(n),
            o(F, t) ? (n.enumerable ? (o(e, D) && e[D][t] && (e[D][t] = !1), n = E(n, {
                enumerable: x(0, !1)
        ...
        J = function(e, t) {
            if (e = w(e), t = _(t, !0), e !== B || !o(F, t) || o(G, t)) {
                var n = k(e, t);
                return ! n || !o(F, t) || o(e, D) && e[D][t] || (n.enumerable = !0),
                n
            }
        },
        Z = function(e) {
        ...
        Q = function(e) {
            for (var t, n = e === B,
            r = A(n ? G: w(e)), i = [], a = 0; r.length > a;) ! o(F, t = r[a++]) || n && !o(B, t) || i.push(F[t]);
            return i
        };
        H || (M = function() {
    ...
    function(e, t, n) {
        ...
        e.exports = {
            ...
            function(e, t, r) {
                try {
                    r = n(13)(Function.call, n(69).f(Object.prototype, "__proto__").set, 2),
                    r(e, []),
    ...
    default)();
        ...
        default)(t, [{
                ...
                value: function() {
                    ...
                    p = t.reactions,
                    d = "";
                    return p && p.totalCount && (d = p.totalCount, 100 === p.totalCount && p.pageInfo && p.pageInfo.hasNextPage && (d = "100+")),
                    m.
                default.createElement("div", {
