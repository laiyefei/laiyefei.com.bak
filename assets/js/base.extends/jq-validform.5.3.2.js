...
(function ($, win, undef) {
    ...
    Validform.util = {
        ...
        getValue: function (obj) {
            ...
            //输入值增加可选是否去除前后空格 hl于17/08/18修改
            var isTrim = obj.attr("isTrim") || true;
            /*if(isTrim == true){
        ...
        _regcheck: function (datatype, gets, obj, curform) {
            ...
            if (mac && mac.length == 4 && mac.indexOf('*') > -1) {
                if (!(gets.gblen() >= mac[2] && gets.gblen() <= mac[3])) {
                    isPassCharLen = false;
                }
            }
